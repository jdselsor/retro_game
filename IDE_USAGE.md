...
*Open the project:*<br>
Run Code::Blocks, and open the project in `retro_game/build/codeblocks`.<br>
Finally, build and run the project.
...
cd retro_game
mkdir ../eclipse-retro_game
cd ../eclipse-retro_game

# Generate an Eclipse project
cmake ../retro_game -G "Eclipse CDT4 - Unix Makefiles"
```
*Open the project:*<br>
Run Eclipse, and open the project in `eclipse-retro_game`.<br>
